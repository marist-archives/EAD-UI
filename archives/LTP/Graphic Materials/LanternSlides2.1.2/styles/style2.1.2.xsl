	...
	<xsl:template match="titleproper">
		...
		<div id="breadcrumbs">
			<ul id="crumbs">
				...
				<li>
					<a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Lantern Slides</a>
				</li>
				<li id="last">
					<xsl:value-of select="."/>
				</li>
	...
	<xsl:template match="c01">
		...
		<table class="tbl" align="center" >
			...
			<tr class="tbldata">
				...
				<th style="width:10px">Index Number</th>
				<th style="width:175px">Title</th>
				<th style="width:85px">Date</th>
				<th style="width:35px">Size (inches)</th>
				<th style="width:35px">Color or b/w</th>
			...
			<xsl:for-each select="c02">
				<tr class="tbldata" id="tblVals">
					<td class="tableFont">
						<xsl:value-of select="did/unitid"/>
					</td>
					<td class="tableFont">
						<xsl:value-of select="did/materialspec[@label='index']"/>
					</td>
					<td class="data">
						<a href="../../digitizedContents/Box {did/container}/B_Scans/{../did/unitid}.{did/container}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle} (Item {did/unitid} - Box {did/container})">
					...
					<td class="tableFont">
						<xsl:value-of select="did/physdesc/physfacet[@type='color']"/>
					</td>
					<td id="checkBox">
