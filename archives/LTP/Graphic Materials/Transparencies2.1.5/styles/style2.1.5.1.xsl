...
<div id="breadcrumbs">
	...
	<li><a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Film negatives</a></li>
...
<xsl:template match="c01">
 ...
 <tr class="tbldata"> 
		...
		<td class="tableFont"><xsl:value-of select="did/unitid"/></td>
		<td class="data"><a href="../../digitizedContents/Box {../did/container}/{../../did/unitid}.{../did/container}.{../did/unitid}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle} (Box {../did/container} - File {../did/unitid} - Item {did/unitid})">
...
<table class="tbl" align="center" >
 <thead>
 <tr>	
 <td class="caption" colspan="4"><a href="35mmSlides2.1.5.1.xml" target="_self" style="text-decoration:none; color:#000000"><xsl:value-of select="note"/></a></td>
 </tr> 
 </thead>
</table><br />
</xsl:template>
...
<table class="tbl" align="center" >
 <thead>
 <tr>	
 <td class="caption" colspan="4"><a href="35mmSlides2.1.5.1-2.xml" target="_self" style="text-decoration:none; color:#000000"><xsl:value-of select="note"/></a></td>
 </tr> 
 </thead>
</table><br />
</xsl:template>
...
<table class="tbl" align="center" >
 <thead>
 <tr>	
 <td class="caption" colspan="4"><a href="35mmSlides2.1.5.1-3.xml" target="_self" style="text-decoration:none; color:#000000"><xsl:value-of select="note"/></a></td>
 </tr> 
 </thead>
</table>
</xsl:template>

<xsl:template match="c01[@type='OTpage2']">
<table class="tbl" align="center" >
 <thead>
 <tr>	
 <td class="caption" colspan="4"><a href="otherTransparencies2.1.5.2-2.xml" target="_self" style="text-decoration:none; color:#000000"><xsl:value-of select="note"/></a></td>
 </tr> 
 </thead>
</table><br />
</xsl:template>
