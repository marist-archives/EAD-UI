...
<!-- Breadcrumb navigation section end -->
 ...
 <tr class="tbldata">
		...
		<td class="data"><a href="../../digitizedContents/Box {did/container}/{../did/unitid}.{did/container}.{did/unitid}.jpg" name="../../digitizedContents/Box {did/container}/{../did/unitid}.{did/container}.{did/unitid}.pdf" onerror="alert('The image could not be loaded.')" rel="prettyPhoto[gallery]" title="{did/unittitle} (Box {../did/container} - File {../did/unitid} - Item {did/unitid})">
  ...
  <xsl:template match="c01[@type='OTpage1']">
<table class="tbl" align="center" >
 <thead>
 <tr>	
 <td class="caption" colspan="4"><a href="otherTransparencies2.1.5.2.xml" target="_self" style="text-decoration:none; color:#000000"><xsl:value-of select="note"/></a></td>
 </tr> 
 </thead>
</table><br />
</xsl:template> 
