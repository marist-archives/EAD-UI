...
<div id="breadcrumbs">
	...
	<li><a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Glass Plate Negatives</a></li>
	<li><a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Lowell Thomas</a></li>
...
<!-- Breadcrumb navigation section end -->
 ...
 <tr class="tbldata">
	  ...
	  <th style="width:75px">Index Number</th>
	  <th style="width:75px">Negative Number</th>
 ...
 <tr class="tbldata">
		...
		<!--td class="data"><a href="{./did/extref/@xlink:href}" rel="prettyPhoto[gallery]" title="{did/extref/unittitle}({did/unitid} of Box {did/container})"><xsl:value-of select="did/extref/unittitle"/><xsl:value-of select="did/unittitle"/></a></td-->
		<!--td class="data"><a href="images/JPEG_{did/container}/JPEG_{did/container} B Scans/{../did/unitid}.{did/container}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle}(Item {did/unitid} - Box {did/container})"-->
		<td class="data"><a href="../../digitizedContents/JPEG_{did/container}/JPEG_{did/container} B Scans/{../did/unitid}.{did/container}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle}(Item {did/unitid} - Box {did/container})">
