...
<div id="breadcrumbs">
	...
	<li><a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Oversize graphic materials</a></li>
...
<!-- Breadcrumb navigation section end -->
 ...
 <tr class="Box">	
 <td class="caption" colspan="6"><xsl:value-of select="."/></td>
 </tr>
 </xsl:for-each>
 <tr class="tbldata">
	  ...
	  <th style="width:50px">Color or b/w</th>
 ...
 <tr class="tbldata">
 		...
 		<td class="data"><a href="../../digitizedContents/Box {did/container}/{../did/unitid}.{did/container}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle} (Box {did/container} - Item {did/unitid})">
		...
		<td class="tableFont"><xsl:value-of select="did/physdesc/extent"/></td>
   		<td class="tableFont"><xsl:value-of select="did/physdesc/physfacet[@type='color']"/></td>
