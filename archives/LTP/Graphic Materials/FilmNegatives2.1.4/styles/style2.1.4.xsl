	...
	<xsl:template match="ead">
		<html>
			<head>
				...
				<link rel="stylesheet" href="../imageViewer/css/prettyPhoto.css" type="text/css" media="screen" charset="utf-8" />
				<link rel="stylesheet" href="/archives/researchcart/styles/style.css" type="text/css" />
	...
	<xsl:template match="titleproper">
		...
		<div id="breadcrumbs">
			<ul id="crumbs">
				...
				<li>
					<a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Graphic Materials</a>
				</li>
				<li>
					<a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Photographs</a>
				</li>
				<li>
					<a href="http://library.marist.edu/archives/LTP/Graphic%20Materials/graphics.xml" target="_self">Film negatives</a>
				</li>
				<li id="last">
					<xsl:value-of select="."/>
				</li>
			...
			<xsl:for-each select="c02">
				...
				<xsl:for-each select="c03">
					<tr class="tbldata">
						...
						<td class="data">
							<a href="../../digitizedContents/Box {../did/container}/{../../did/unitid}.{../did/container}.{../did/unitid}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle} (Box {../did/container} - File {../did/unitid} - Item {did/unitid})">
								<xsl:value-of select="did/unittitle"/>
							</a>
						</td>
						<td class="tableFont"></td>
				...
				<thead>
					<tr>
						<td class="caption" colspan="4">
							<a href="subjectFiles2.1.4.3.xml" target="_self" style="text-decoration:none; color:#000000">
		...
		<xsl:template match="c01[@type='page2']">
			<table class="tbl" align="center" >
				<thead>
					<tr>
						<td class="caption" colspan="4">
							<a href="subjectFiles2.1.4.3-2.xml" target="_self" style="text-decoration:none; color:#000000">
								<xsl:value-of select="note"/>
							</a>
						</td>
					</tr>
