...
<!-- Template for eadheader -->
 ...
 <tr class="tbldata"> 
	...
	<td class="data">
		<a href="../digitizedContents/Box {did/container}/{../did/unitid}.{did/container}.{did/unitid}.jpg" rel="prettyPhoto[gallery]" title="{did/unittitle} (Box {../did/container} - File {../did/unitid} - Item {did/unitid})">
